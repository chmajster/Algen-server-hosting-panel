...
from wtforms.validators import DataRequired, InputRequired, Length, Optional, URL
...
class WebhookEndpointForm(FlaskForm):
    ...
    client_id = SelectField("Zakres klienta", coerce=int, validators=[InputRequired()], choices=[])
