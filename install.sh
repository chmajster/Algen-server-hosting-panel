...
REGISTRATION_AUTO_LOGIN="${REGISTRATION_AUTO_LOGIN:-true}"
...
TWO_FACTOR_EMAIL_CODE_TTL_SECONDS="${TWO_FACTOR_EMAIL_CODE_TTL_SECONDS:-300}"
TWO_FACTOR_EMAIL_SUBJECT="${TWO_FACTOR_EMAIL_SUBJECT:-Kod logowania 2FA}"
...
TICKETS_EMAIL_NOTIFICATIONS_ENABLED="${TICKETS_EMAIL_NOTIFICATIONS_ENABLED:-true}"
TICKETS_EMAIL_SUBJECT_NEW_CLIENT_TICKET="${TICKETS_EMAIL_SUBJECT_NEW_CLIENT_TICKET:-Nowy ticket klienta: {ticket}}"
TICKETS_EMAIL_SUBJECT_CLIENT_REPLY="${TICKETS_EMAIL_SUBJECT_CLIENT_REPLY:-Nowa odpowiedz klienta: {ticket}}"
TICKETS_EMAIL_SUBJECT_STAFF_REPLY="${TICKETS_EMAIL_SUBJECT_STAFF_REPLY:-Nowa odpowiedz supportu: {ticket}}"
TICKETS_ATTACHMENT_MAX_BYTES="${TICKETS_ATTACHMENT_MAX_BYTES:-5242880}"
TICKETS_ATTACHMENT_ALLOWED_EXTENSIONS="${TICKETS_ATTACHMENT_ALLOWED_EXTENSIONS:-txt,pdf,png,jpg,jpeg,gif,zip,tar,gz,log,csv,json}"
TICKETS_SLA_FIRST_RESPONSE_MINUTES="${TICKETS_SLA_FIRST_RESPONSE_MINUTES:-120}"
TICKETS_ESCALATION_MINUTES="${TICKETS_ESCALATION_MINUTES:-240}"
TICKETS_ESCALATION_ENABLED="${TICKETS_ESCALATION_ENABLED:-true}"
...
generate_env() {
  ...
  set_env_key "SELF_REGISTRATION_ENABLED" "$SELF_REGISTRATION_ENABLED"
  set_env_key "REGISTRATION_AUTO_LOGIN" "$REGISTRATION_AUTO_LOGIN"
  ...
  set_env_key "TWO_FACTOR_EMAIL_ENABLED" "$TWO_FACTOR_EMAIL_ENABLED"
  set_env_key "TWO_FACTOR_EMAIL_CODE_TTL_SECONDS" "$TWO_FACTOR_EMAIL_CODE_TTL_SECONDS"
  set_env_key "TWO_FACTOR_EMAIL_SUBJECT" "$TWO_FACTOR_EMAIL_SUBJECT"
  set_env_key "MAIL_SERVER" "$MAIL_SERVER"
  set_env_key "MAIL_PORT" "$MAIL_PORT"
  set_env_key "MAIL_USERNAME" "$MAIL_USERNAME"
  set_env_key "MAIL_PASSWORD" "$MAIL_PASSWORD"
  set_env_key "MAIL_USE_TLS" "$MAIL_USE_TLS"
  set_env_key "MAIL_USE_SSL" "$MAIL_USE_SSL"
  set_env_key "MAIL_FROM" "$MAIL_FROM"
  set_env_key "TICKETS_EMAIL_NOTIFICATIONS_ENABLED" "$TICKETS_EMAIL_NOTIFICATIONS_ENABLED"
  set_env_key "TICKETS_EMAIL_SUBJECT_NEW_CLIENT_TICKET" "$TICKETS_EMAIL_SUBJECT_NEW_CLIENT_TICKET"
  set_env_key "TICKETS_EMAIL_SUBJECT_CLIENT_REPLY" "$TICKETS_EMAIL_SUBJECT_CLIENT_REPLY"
  set_env_key "TICKETS_EMAIL_SUBJECT_STAFF_REPLY" "$TICKETS_EMAIL_SUBJECT_STAFF_REPLY"
  set_env_key "TICKETS_ATTACHMENT_MAX_BYTES" "$TICKETS_ATTACHMENT_MAX_BYTES"
  set_env_key "TICKETS_ATTACHMENT_ALLOWED_EXTENSIONS" "$TICKETS_ATTACHMENT_ALLOWED_EXTENSIONS"
  set_env_key "TICKETS_SLA_FIRST_RESPONSE_MINUTES" "$TICKETS_SLA_FIRST_RESPONSE_MINUTES"
  set_env_key "TICKETS_ESCALATION_MINUTES" "$TICKETS_ESCALATION_MINUTES"
  set_env_key "TICKETS_ESCALATION_ENABLED" "$TICKETS_ESCALATION_ENABLED"
  ...
  set_env_key "WEBHOOKS_ENABLED" "$WEBHOOKS_ENABLED"
